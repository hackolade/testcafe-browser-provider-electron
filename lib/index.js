...
var DEBUG_LOGGER = (0, _debug2.default)('testcafe:browser-provider-electron');
var STDOUT_LOGGER = DEBUG_LOGGER.extend('spawn:stdout');
var STDERR_LOGGER = DEBUG_LOGGER.extend('spawn:stderr');
...
function startElectron(config, ports) {
    ...
    if (config.enableDebug) debugPortsArgs.unshift('--debug-brk=' + ports[0]);
    ...
    var proc = (0, _child_process.spawn)(cmd, args, { stdio: ['ignore', 'pipe', 'pipe'] });

    proc.stdout.on('data', function (buf) {
        return STDOUT_LOGGER(_lodash2.default.trimEnd(String(buf), '\n'));
    });
    proc.stderr.on('data', function (buf) {
        return STDERR_LOGGER(_lodash2.default.trimEnd(String(buf), '\n'));
    });
}
...
var ElectronBrowserProvider = {
    ...
    openBrowser: function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(id, pageUrl, mainPath) {
            var config, ipcServer, ports, hookCode, debugClient, inspectClient, clients, injectingStatus;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 7:
                            ...
                            clients = [inspectClient];


                            if (config.enableDebug) clients.unshift(debugClient);

                            _context3.next = 16;
                            return _pinkie2.default.race(clients.map(function (client) {
                                return injectHookCode(client, hookCode);
                            }));
